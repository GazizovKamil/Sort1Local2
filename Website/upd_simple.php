      ...
      <div class = "container">
        <table class="table6" style="font-size: 10px; " border="0"><tbody>
          ...
          <tr>
            ...
            <td class="border" style="width: 410px;" colspan="2"> он же</td>
            <td style="width: 20px; padding-left: 0px;">(3)</td>
            <td style="padding-left: 8px; width: 280px">Валюта: наименование, код</td>
            <td  class="border" style="width: 410px;">Российский рубль, 643 </td>
        ...
        foreach($zakaz_details as $zd_key=>$zd_val){?>
          <tr>
            <td id="line2"><?php echo $zd_val['article'];?></td><td><?php echo $i ?></td><td id="detail_name_<?php echo $i;?>" onclick="change_detail_name(<?php echo $i;?>);"><?php echo $zd_val['name'].' ('.$zd_val['brand'].' '.$zd_val['article'].')';?></td><td></td><td></td><td></td><td><?php echo $zd_val['count']?></td>
            <td><?php
        ...
        ?>
          ...
          <tr>
            <td id="line2"></td><td colspan="7" style="text-align: left; padding-left: 8px;"><b>Всего к оплате</b></td><td nowrap><?php echo number_format($sum_without_nds,2,"."," ");?></td>
        ...
        <table class="table6" style="font-size: 10px;"><tbody>
          <tr>
            <td rowspan="5" style="width: 73px; padding:0px;" id="line"><p>Документ</p> <p>составлен на</p><p><?php if($pages>1) echo $pages." листах"; else echo "1 листе";?></p></td>
          ...
          <tr><td style="width: 67px;" id="line"></td><td colspan="9" style="height: 2px; border-bottom: 2px solid #000000;"></td></tr>
        </tbody></table>
