...
if (isset($_SESSION['user_id']) && (int)$_SESSION['user_id']>0){
    ...
    $content='
<form id="new_document_form">
  <div class="form-group row">
    <label for="sklad_name" class="col-sm-3 col-form-label">Выберите склад</label>
    <div class="col-sm-9">
    <input type="text" class="form-control" name="sklad_id" value="'.$sklad_data['id'].'">
    </div>
  </div>
