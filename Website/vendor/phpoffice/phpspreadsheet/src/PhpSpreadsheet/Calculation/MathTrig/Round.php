...
class Round
{
    ...
    public static function up($number, $digits): array|string|float
    {
        ...
        try {
            $number = Helpers::validateNumericNullBool($number);
            $digits = (int) Helpers::validateNumericNullSubstitution($digits, \Pchp\Core\PhpValue::Null);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    ...
    public static function multiple(mixed $number, mixed $multiple): array|string|int|float
    {
        ...
        try {
            ...
            $multiple = Helpers::validateNumericNullSubstitution($multiple, \Pchp\Core\PhpValue::Null);
        } catch (Exception $e) {
            return $e->getMessage();
        }
