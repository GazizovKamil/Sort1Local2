...
class Floor
{
    ...
    public static function math(mixed $number, mixed $significance = null, mixed $mode = 0)
    {
        ...
        try {
            $number = Helpers::validateNumericNullBool($number);
            $significance = Helpers::validateNumericNullSubstitution($significance, ($number < 0) ? -1 : 1);
            $mode = Helpers::validateNumericNullSubstitution($mode, \Pchp\Core\PhpValue::Null);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    ...
    public static function precise($number, $significance = 1)
    {
        ...
        try {
            $number = Helpers::validateNumericNullBool($number);
            $significance = Helpers::validateNumericNullSubstitution($significance, \Pchp\Core\PhpValue::Null);
        } catch (Exception $e) {
            return $e->getMessage();
        }
