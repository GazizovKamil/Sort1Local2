...
class Combinations
{
    ...
    public static function withoutRepetition(mixed $numObjs, mixed $numInSet): array|string|float
    {
        ...
        try {
            $numObjs = Helpers::validateNumericNullSubstitution($numObjs, \Pchp\Core\PhpValue::Null);
            $numInSet = Helpers::validateNumericNullSubstitution($numInSet, \Pchp\Core\PhpValue::Null);
