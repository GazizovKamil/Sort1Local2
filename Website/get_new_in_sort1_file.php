...
session_write_close();
$mfile_data=$db->getRow("select * from new_in_sort1_files where id=?i",(int)$file_id);
//echo print_r($mfile_data,true)."\n";
$permition=$db->getOne("select id from new_in_sort1 where id=?i",(int)$mfile_data['new_in_sort1_id']);
